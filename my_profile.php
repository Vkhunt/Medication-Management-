    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          if ($con) {
            $query = "SELECT * FROM admin_credentials LIMIT 1";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
              ...
              echo "<script>console.warn('No admin data found.');</script>";
            }
          } else {
            echo "<script>console.error('Database connection failed.');</script>";
          }
        ?>
        <div class="row">
