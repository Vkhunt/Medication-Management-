...
<html lang="en" dir="ltr">
  <head>
    ...
    <script>
  emailjs.init("5tJROOnbN770tVu7J"); // Replace with your actual EmailJS public key 'service_x46cd5r', 'template_rhi2m66'
  ...
  alert("Email sent successfully!");
    ...
    <script> 
  (function(){
     emailjs.init("5tJROOnbN770tVu7J"); // Replace with your actual user id
...
<script src="js/add_new_invoice.js"></script>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header" style="background-color: #ff5252; color: white">
            ...
            <button class="close" style="outline: none;" onclick="document.getElementById('add_new_customer_model').style.display = 'none';">
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <div class="row">
          ...
          <!-- New row added for Email field -->
          <div class="col col-md-1 form-group"></div>
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="customer_email">Email :</label>
              <input id="customer_email" type="email" class="form-control" name="customer_email" placeholder="Enter Email" required>
            </div>
      
          <!-- End of email field row -->
            </div>
          ...
          <div class="row col col-md-12">
            <div id="save_button" class="col col-md-2 form-group float-right">
              ...
              <button type="button" class="btn btn-success" onclick="addInvoice(); sendPurchaseNotification();">
  Save
</button>
  ...
  function sendPurchaseNotification() {
    const email = document.getElementById('customer_email').value;
    const customer = document.getElementById('customers_name').value;
